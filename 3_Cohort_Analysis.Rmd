...
recurrent = read.xlsx("Данные для анализа UPD.xlsx", sheet = 1, startRow = 1, colNames = TRUE)
transactions = read.xlsx("Данные для анализа UPD.xlsx", sheet = 2, startRow = 1, colNames = TRUE) 
```

# What is this project about?

<center>
![](C:/Users/timur/OneDrive/Documents/R Studio Tasks/CV/charity.jpg)
